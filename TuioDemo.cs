...
public class TuioDemo : Form, TuioListener
{
    ...
    int jabct=0, crossct=0, lhookct=0, rhookct=0;
                ...
                foreach (TuioObject tobj in objectList.Values)
                {
                    ...
                    switch (tobj.SymbolID)
                    {
                        ...
                        case 0:
                            ...
                            break;
                        case 1:
                            objectImagePath = Path.Combine(Environment.CurrentDirectory, "Glove-pos/cross.png");
                            backgroundImagePath = Path.Combine(Environment.CurrentDirectory, "Boxing.jpeg");
                            crossct++;
                            break;
                        case 2:
                            objectImagePath = Path.Combine(Environment.CurrentDirectory, "Glove-pos/rhook.png");
                            backgroundImagePath = Path.Combine(Environment.CurrentDirectory, "Boxing.jpeg");
                            rhookct++;
                            break;

                        case 3:
                            objectImagePath = Path.Combine(Environment.CurrentDirectory, "Glove-pos/LGaurd.png");
                            backgroundImagePath = Path.Combine(Environment.CurrentDirectory, "Boxing.jpeg");
                            break;
                        case 4:
                            objectImagePath = Path.Combine(Environment.CurrentDirectory, "Glove-pos/jab.png");
                            backgroundImagePath = Path.Combine(Environment.CurrentDirectory, "Boxing.jpeg");
                            jabct++;
                            break;
                        case 5:
                            objectImagePath = Path.Combine(Environment.CurrentDirectory, "Glove-pos/lhook.png");
                            backgroundImagePath = Path.Combine(Environment.CurrentDirectory, "Boxing.jpeg");
                            lhookct++;
                            break;
                        default:
